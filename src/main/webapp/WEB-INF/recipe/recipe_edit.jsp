                    ...
                    <form method="post">
                        ...
                        <table class="table borderless">
                            ...
                            <tr class="d-flex">
                                ...
                                <td class="col-7">
                                    <textarea name="desc" class="w-100 p-1" rows="5">${recipe.getDescription()}</textarea>
                                </td>
                            </tr>
                            <tr class="d-flex">
                                <th scope="row" class="col-2">Przygotowanie (minuty)</th>
                                <td class="col-3">
                                    <input class="p-1" name="time" type="number" value="${recipe.getPreparationTime()}">
                                </td>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="row d-flex">
                            <div class="col-5 p-4">
                                <textarea class="w-100 p-1" name="prepDesc" rows="10">${recipe.getPreparation()}</textarea>
                            </div>
                            <div class="col-2"></div>
