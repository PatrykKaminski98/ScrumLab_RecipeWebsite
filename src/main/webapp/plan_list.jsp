                ...
                <div class="schedules-content">
                    <table class="table border-bottom">
                        ...
                        <tr class="d-flex">
                            ...
                            <td class="col-2 d-flex align-items-center justify-content-center  flex-wrap"><a href="${pageContext.request.contextPath}/app/plan/delete?id=${plan.id}" class="btn btn-danger rounded-0 text-light m-1 delete-button">Usuń</a>
...
<script src="${pageContext.request.contextPath}/js/plan_delete.js"></script>